...
class ESIM(nn.Module):
    def __init__(self, arg,hihdden_size,dropout=0.5, num_classes=2, device="gpu"):
        super(ESIM, self).__init__()
        self.embedding_dim = arg.embedding_dim
        self.hidden_size = hihdden_size
        self.num_classes = num_classes
        self.word_embedding = nn.Embedding(arg.vocabs_size + 1, embedding_dim=arg.embedding_dim)
