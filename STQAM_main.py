...
from STQAM_run import train,valid,test
from models.STQAM_MODEL import STQAM
...
def main():
    ...
    parser.add_argument('--with_label', type=int, default=0, help='with label 1 or without label 0')
    ...
    model = STQAM(params, device=device).to(device)
    ...
    #
        ...
        time_test,label_auc_test,match_auc_test = test(params,model,test_sentence,test_user,test_timestamp,
                                                           test_label,test_match,params.with_label)
